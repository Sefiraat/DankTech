...
public final class Messages {
    ...
    public static final String MessageCommandSelectItem = Prefix + Notice + "Please select an item type";
    ...
    public static final String MessageEventInputExisting = Prefix + Warning + "Slot is already assigned.";
